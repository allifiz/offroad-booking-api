...
Route::prefix('v1')->group(function (): void {
    ...
    Route::prefix('driver')
        ...
        ->group(function (): void {
            ...
            Route::post('/vehicles/{vehicle}/documents', [DriverVehicleMediaController::class, 'storeDocument']);
            Route::post('/vehicles/{vehicle}/documents/{vehicleDocument}/reupload', [DriverDocumentController::class, 'reuploadVehicleDocument']);
            Route::post('/vehicles/{vehicle}/photos', [DriverVehicleMediaController::class, 'storePhoto']);
            Route::put('/vehicles/{vehicle}/photos/order', [DriverVehicleMediaController::class, 'reorderPhotos']);
            Route::delete('/vehicles/{vehicle}/photos/{vehiclePhoto}', [DriverVehicleMediaController::class, 'destroyPhoto']);
